...
CREATE TABLE dyma_user_role (
    ...
    CONSTRAINT fk_role_name FOREIGN KEY (role_name) REFERENCES public.dyma_role(name),
    CONSTRAINT fk_user_id FOREIGN KEY (user_id) REFERENCES public.dyma_user(id)
);